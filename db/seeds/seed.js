...
async function main() {
  ...
  await sharedPhotoCategoriesRepo.save([
    { sharedPhotos: savedPhotos[0], categories: animal },
    { sharedPhotos: savedPhotos[1], categories: animal },
    { sharedPhotos: savedPhotos[2], categories: animal },
    { sharedPhotos: savedPhotos[2], categories: travel },
    { sharedPhotos: savedPhotos[3], categories: nature },
    { sharedPhotos: savedPhotos[4], categories: nature },
    { sharedPhotos: savedPhotos[4], categories: travel },
    { sharedPhotos: savedPhotos[5], categories: food },
    { sharedPhotos: savedPhotos[6], categories: food },
    { sharedPhotos: savedPhotos[7], categories: city },
    { sharedPhotos: savedPhotos[7], categories: travel },
    { sharedPhotos: savedPhotos[8], categories: architecture },
    { sharedPhotos: savedPhotos[9], categories: city },
    { sharedPhotos: savedPhotos[10], categories: technology },
    { sharedPhotos: savedPhotos[11], categories: technology },
    { sharedPhotos: savedPhotos[11], categories: nature },
    { sharedPhotos: savedPhotos[12], categories: travel },
    { sharedPhotos: savedPhotos[12], categories: nature },
    { sharedPhotos: savedPhotos[13], categories: travel },
    { sharedPhotos: savedPhotos[13], categories: nature },
    { sharedPhotos: savedPhotos[14], categories: coffee },
    { sharedPhotos: savedPhotos[14], categories: food },
    { sharedPhotos: savedPhotos[15], categories: coffee },
    { sharedPhotos: savedPhotos[15], categories: food }
  ]);
